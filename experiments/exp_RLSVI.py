...
J = Jlist[array_idx[0]] # number of artifial samples
...
def experiment(itr):
    ...
    for userid in userid_all:
        ...
        env = Env(config)
        L = config.W # number of days in an episode
        ...
        rlsvi = LSVI(config, H, lam_beta, standardize=False)
