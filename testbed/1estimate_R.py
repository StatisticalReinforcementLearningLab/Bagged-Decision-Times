...
for userid in userid_all:
    ...
    ## User 10044 has 270 days of record and dropped out on day 65
    ## User 10262 has 210 days of record and dropped out on day 192
    ## Further any data past the 83rd day on any user cannot be used to 
    ## construct the simulation testbed. This is for IRB reasons.
    if userid in [10044, 10262]:
        dat_user1 = dat_user1[dat_user1['day'] <= 83]
